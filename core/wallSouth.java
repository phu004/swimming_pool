package core;
public class wallSouth extends solidObject{
	
	public wallSouth(vector origin){
	...
	public void makePolygons(){
		...
		polygons[0] = new polygon3D(new vector[]{v[0],v[1],v[2],v[3]}, v[0], v[1], v[3], mainThread.textures[12], 16, 1, 6 );
		polygons[1] = new polygon3D(new vector[]{v[4],v[5],v[6],v[7]}, v[4], v[5], v[7], mainThread.textures[13], 10, 1, 6 );
